    ...
    return ButtonTheme(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: ( appTheme.getDarkTheme ) ? appTheme.getCurrenteTheme.colorScheme.primary : const Color(0xffED6762),
        ...
        child: Text('CREATE NEW LIST',
          style: TextStyle( 
            color: appTheme.getCurrenteTheme.scaffoldBackgroundColor,
            fontSize: 18,
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text( "New", 
            style: TextStyle(
              color: ( appTheme.getDarkTheme ) ? Colors.grey : const Color(0xff532128),
              fontSize: 50)
            ),
        ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: ( appTheme.getDarkTheme ) ? Colors.grey : const Color(0xffF7CDD5),
